        ...
        <ul class="pagination">
            ...
            @else
                <li class="paginate_button page-item previous" id="kt_datatable_previous">
                    <a href="{{ $paginator->previousPageUrl() }}#products" aria-controls="kt_datatable" data-dt-idx="1" tabindex="0" class="page-link">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        ...
                        @else
                            <li class="page-item"><a class="page-link" href="{{ $url }}#products">{{ $page }}</a></li>
                        @endif
                    @endforeach
                @endif
            @endforeach
            ...
            @if ($paginator->hasMorePages())
                <li class="paginate_button page-item next" id="kt_datatable_next">
                    <a href="{{ $paginator->nextPageUrl() }}#products" aria-controls="kt_datatable" data-dt-idx="7" tabindex="0" class="page-link">
