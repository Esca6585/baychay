...
@section('title')
{{ __('Message') }} {{ __( ucfirst( request()->segment(count(request()->segments())) ) ) }}
@endsection
                                        ...
                                        <div class="d-flex align-items-center border-dashed card-rounded p-5 p-lg-10 mb-14">
														...
														<div class="text-center flex-shrink-0 me-7 me-lg-13">
															...
															<div class="symbol symbol-70px symbol-circle mb-2">
																<img src="{{ asset('metronic-template/v7/assets/media/icons/duotone/General/User.svg') }}" class="" alt="{{ asset('metronic-template/v7/assets/media/icons/duotone/General/User.svg') }}">
															</div>
															<!--end::Avatar-->
															<!--begin::Info-->
															<div class="m-5">
																<a href="/metronic8/demo1/../demo1/pages/profile/overview.html" class="text-gray-700 fw-bolder text-hover-primary">{{ $message->name }}</a>
																<span class="text-gray-400 fs-7 fw-bold d-block mt-1">{{ $message->email }}</span>
															</div>
															<!--end::Info-->
														</div>
														<!--end::Section-->
														...
														<div class="m-5 fs-6">
                                                            <div class="text-muted fw-bold lh-lg m-5">
                                                                <textarea name="" id="" cols="30" rows="10">{{ $message->messages }}</textarea>
                                                            </div>
														</div>
														<!--end::Text-->
													</div>
